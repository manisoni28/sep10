...
import com.android.plagochat.ui.FriendsFragment;
import com.android.plagochat.ui.GroupFragment;
import com.android.plagochat.ui.LoginActivity;
import com.android.plagochat.ui.UserProfileFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(toolbar != null) {
            ...
            getSupportActionBar().setTitle("PlagoChat");
        }
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.about) {
            Toast.makeText(this, "PlagoChat version 1.0", Toast.LENGTH_LONG).show();
            return true;
        }
